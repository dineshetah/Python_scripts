...
# #print(f"\n After having been cleaned up, the {len(all_prices)} price now look like this: \n")
# #print(all_prices)
...
#     driver.get("https://docs.google.com/forms/d/e/1FAIpQLSd7DDhqQXprJUIEfQGbsPrRUscWrXEmY5G9xEKcAGwmVi9tdQ/viewform?usp=sf_link")
#     time.sleep()
...
for n in range(len(all_links)):
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSd7DDhqQXprJUIEfQGbsPrRUscWrXEmY5G9xEKcAGwmVi9tdQ/viewform?usp=sf_link")
    time.sleep(3)  # You should specify the time you want the program to sleep for in seconds
...
address.send_keys(all_address_elements[n])
